...
import userorange from '../../icons/orange.png';
                        ...
                        (
                            <div key={i} className='review-card'>
                                <div className='review-card-user-info'>
                                    <img className='review-usericon' src={userorange} alt='user' onError={e => e.target.src=broken} />
                                ...
                                <div className='image-container-review'>
                                    <img src={rev.Image.url} alt='review' className='review-image-prev' onError={e => e.target.src=broken} />
                                </div>
                ...
                <div className='categories-container'>
                    <div className='categories-outer-container'>
                        <a className='category-link' href='/biz?type=chinese'>
                            <div className='category-tile chinese-tile'>
                                <img className='category-icon' src={chinese} alt='chinese' onError={e => e.target.src=broken} />
                    ...
                    <div className='categories-outer-container'>
                        <a className='category-link' href='/biz?type=indian'>
                            <div className='category-tile chinese-tile'>
                                <img className='category-icon' src={indian} alt='chinese' onError={e => e.target.src=broken} />
                                <p className='category-title'>
                                    Indian
                                </p>
                            </div>
                    ...
                    <div className='categories-outer-container'>
                        <a className='category-link' href='/biz?type=italian'>
                            <div className='category-tile chinese-tile'>
                                <img className='category-icon' src={italian} alt='chinese' onError={e => e.target.src=broken} />
                                <p className='category-title'>
                                    Italian
                                </p>
                            </div>
                    ...
                    <div className='categories-outer-container'>
                        <a className='category-link' href='/biz?type=japanese'>
                            <div className='category-tile chinese-tile'>
                                <img className='category-icon' src={japanese} alt='chinese' onError={e => e.target.src=broken} />
                                <p className='category-title'>
                                    Japanese
                                </p>
                            </div>
                ...
                <div className='categories-container'>
                    <div className='categories-outer-container'>
                        <a className='category-link' href='/biz?type=korean'>
                            <div className='category-tile chinese-tile'>
                                <img className='category-icon' src={korean} alt='chinese' onError={e => e.target.src=broken} />
                                <p className='category-title'>
                                    Korean
                                </p>
                            </div>
                    ...
                    <div className='categories-outer-container'>
                        <a className='category-link' href='/biz?type=mexican'>
                            <div className='category-tile chinese-tile'>
                                <img className='category-icon' src={mexican} alt='chinese' onError={e => e.target.src=broken} />
                                <p className='category-title'>
                                    Mexican
                                </p>
                            </div>
                    ...
                    <div className='categories-outer-container'>
                        <a className='category-link' href='/biz?type=thai'>
                            <div className='category-tile chinese-tile'>
                                <img className='category-icon' src={thai} alt='chinese' onError={e => e.target.src=broken} />
                                <p className='category-title'>
                                    Thai
                                </p>
                            </div>
                    ...
                    <div className='categories-outer-container'>
                        <a className='category-link' href='/biz?type=vietnamese'>
                            <div className='category-tile chinese-tile'>
                                <img className='category-icon' src={vietnamese} alt='chinese' onError={e => e.target.src=broken} />
                                <p className='category-title'>
                                    Vietnamese
                                </p>
                            </div>
