        ...
        if (bizImages.length < 3) {
            ...
            imageHeader = (
                <span key={obj?.id} className='single-business-single-image-wrapper' id='just-one-business-img' >
                    <img className='single-business-one-image' alt="" src={obj?.url} onError={e => e.target.src=broken} />
                </span>
            )
        }
        imageHeader = bizImages.slice(0, 3).map(obj => {
            return (
                <span key={obj.id} className='single-business-one-image-wrapper' >
                    <img className='single-business-one-image' alt={obj.id} src={obj.url} onError={e => e.target.src=broken} />
                </span>
            )
        })
    }
            ...
            return (
                <div>
                    <div className='single-business-user'>
                        <div>
                            <img height="64" width="64" src={obj.User.profile_pic} alt="profile_pic" onError={e => e.target.src=broken} />
                        </div>
                    ...
                    <div className='single-business-review-body'>
                        ...
                        {obj.Review_Images && obj.Review_Images.map(obj => {
                            return (
                                <>
                                <img className='single-business-review-image' src={obj.url} alt={obj.url} onError={e => e.target.src=broken} />
                                </>
                            )
                        }
                        )}
                ...
                <>
                    <Modal id='photo-modal' onClose={() => {
                        ...
                        <div className='photo-modal-close' onClick={() => setShowPhotoModal(false)}>
                            Close <img src={x} alt="x_svg" onError={e => e.target.src=broken} />
                        </div>
                        ...
                        <div className='single-business-modal-images'>
                            ...
                            {bizImages.length > 0 && bizImages.map(obj => {
                                return (
                                    <img onClick={() => setShowSinglePhoto(true)} className='single-business-modal-review-image' src={obj.url} alt={obj.url} onError={e => e.target.src=broken} />
                                )
                            }
                            )}
                            {allReviewImages.length > 0 && allReviewImages.map(obj => {
                                return (
                                    <img className='single-business-modal-review-image' src={obj.url} alt={obj.url} onError={e => e.target.src=broken} />
                                )
                            })}
                        </div>
                    </Modal>
                    ...
                    <div className='single-business-header-info'>
                        <div className='single-business-details'>
                            ...
                            <div className='single-business-claimedtypes'>
                                <img alt='check' width="16" height="16" src={check} onError={e => e.target.src=broken} />
                                <span>
                        ...
                        <div className='single-business-review-bar'>
                            <div className='single-business-review-bar-button'>
                                <NavLink id='sb-review-button' style={{ textDecoration: 'none', color: "white" }} to={reviewUsers.includes(currUserId) ? `/biz/${biz.id}/review/${currUserReviewId}/` : `/newreview/biz/${biz.id}`}>
                                    <span className='single-business-reviewButton'>
                                        <img width='24' height='24' src={star} alt="star_svg" onError={e => e.target.src=broken} />
                            ...
                            <div className='sb-user-buttons'>
                                <NavLink className="single-business-user-bar-button" to={`/biz/${biz.id}/update`}>
                                    <img className="user-biz-svg" src={pencil} width='16px' alt="pencil_svg" onError={e => e.target.src=broken} />
                                    Update Business
                                </NavLink>
                                <span
                                ...
                                >
                                    <img className="user-biz-svg" src={trash} width='16px' alt="trash_svg" onError={e => e.target.src=broken} />
                                    Delete Business
                                </span>
                            </div>
                            )}
                    ...
                    <div className='single-business-contact-details'>
                        {biz.phone_number && (
                            <div className='single-business-contact'>
                                ...
                                <img width='24' height='24' src={phone} alt="phone_svg" onError={e => e.target.src=broken} />
                            </div>
                        )}
                        {biz.address && (
                            <div className='single-business-contact'>
                                <div>{biz.address} {biz.city}, {biz.state} </div>
                                <img width='24' height='24' img src={map} alt="map_svg" onError={e => e.target.src=broken} />
                            </div>
                        )}
                    </div>
