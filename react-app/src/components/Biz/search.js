              ...
              {biz.name}
                        ...
                        >
                            <div className="biz-img-box" >
                                <img id='biz-img' src={biz.Business_Images[0].url} alt='biz-img' onError={e => e.target.src=broken} />
                            </div>
                            <div className="biz-info-box">
                                ...
                                <div id='biz-rev'>
                                    <img src={txtbub} alt='txtbubble' width='16px' height='14px' onError={e => e.target.src=broken} />
                                    <div id='biz-rev-p'>
                                ...
                                <div id='biz-tras'>
                                    <span id='tra-text'>
                                        ...
                                        ).length ? check : x} onError={e => e.target.src=broken} /> Pickup
                                    </span>
                                    <span id='tra-text'>
                                        <img alt='tra-img' width='16px' height='10px' src={!!Object.values(biz.transactions).filter(ele =>
                                            ele.transaction === 'delivery'
                                        ).length ? check : x} onError={e => e.target.src=broken} /> Delivery
                                    </span>
                                    <span id='tra-text'>
                                        <img alt='tra-img' width='16px' height='10px' src={!!Object.values(biz.transactions).filter(ele =>
                                            ele.transaction === 'restaurant_reservation'
                                        ).length ? check : x} onError={e => e.target.src=broken} /> Reservations
                                    </span>
