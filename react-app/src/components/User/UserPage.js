    ...
    return (
        <>
            ...
            <div className='user-prof'>
                <div id='left-col'>
                    <button id='user-img'>
                        <img id='orange-outline' src={user.profile_pic ? user.profile_pic : orange} alt='orange-outline' width='100%' height='100%' objectFit='cover' onError={e => e.target.src=broken} />
                    </button>
                    <h3 id='bar-name'>{user.first_name}'s Profile</h3>
                    <div className='side-bar'>
                        {/* -----------------------OVERVIEW--------------------- */}
                        <NavLink to='/current' id='bar-row'>
                            <img id='bar-img' src={orange} alt='orange' width='25px' onError={e => e.target.src=broken} />
                            <div id='bar-txt'>Profile Overview</div>
                        </NavLink>
                        {/* -----------------------REVIEWS--------------------- */}
                        <NavLink to='/reviews/current' id='bar-row'>
                            <img id='bar-img' src={starGrey} alt='star-grey' width='25px' onError={e => e.target.src=broken} />
                            <div id='bar-txt'>
                        ...
                        <NavLink to='/biz/current' id='bar-row'>
                            <img id='bar-img' src={savedBiz} alt='star-grey' width='25px' onError={e => e.target.src=broken} />
                ...
                <div id='mid-col'>
                    <div className='user-info'>
                        ...
                        <div className='user-icons'>
                            <div id='user-rev'>
                                <img src={starOran} alt='star' onError={e => e.target.src=broken} />
                                <p id='user-txt'>
                            ...
                            {/* <div id='user-pht'>
                                <img src={cam} alt='cam' width='24px' onError={e => e.target.src=broken} />
              ...
              <button to='/current' id='recent-act-user-container'>
                <img id='recent-act-user-pic' src={user.profile_pic ? user.profile_pic : orange} onError={e => e.target.src=broken} />
              </button>
            </div> */}
                        </div>
                    )}
                ...
                <div id='right-col'>
                    <div id='top-rc'>
                        {/* <h5 id='top-rc-text'>
                            <img src={cam} alt='add-prof-img' width='15px' onError={e => e.target.src=broken} />
                            Add Profile Photo
                        </h5> */}
                        <h5 id='top-rc-text'>
                            <img src={upProf} alt='up-prof' width='15px' onError={e => e.target.src=broken} />
                            Update Your Profile
                        </h5>
                    </div>
                    {url === '/current' && (
                        <div id='bot-rc'>
                            ...
                            <div id='bot-rc-1'>
                                <img src={savedBiz} alt='save' width='16px' height='16px' onError={e => e.target.src=broken} />
                                <p id='bot-rc-txt'>
                            ...
                            <h5 id='bot-rc-title'>Gulping Since 2022</h5>
                            <div id='bot-rc-1'>
                            </div>
                        </div>
                    )}
