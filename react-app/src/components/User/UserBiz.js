                    ...
                    <div className="single-user-biz-card" key={biz.id}>
                        <div className="user-biz-info">
                            {biz.Business_Images && biz.Business_Images.length > 0 && (
                                <NavLink exact to={`/biz/${biz.id}`}>
                                    <img className="user-biz-prev-img" src={biz.Business_Images[0].url} alt={biz.name} onError={e => e.target.src=broken} />
                                </NavLink>
                            )}
                            ...
                            <div className="user-biz-imgs">
                                {biz.Business_Images && biz.Business_Images.length > 0 && biz.Business_Images.map(img => (
                                    <div className="user-biz-img-container" key={img.id} onClick={() => deleteImgHandler(biz.id, img.id)}>
                                        <img className="user-biz-svg-x" src={x} width='100px' alt="x_svg" onError={e => e.target.src=broken} />
                                        <img className="user-biz-img" key={img.id} src={img.url} alt={img.url} onError={e => e.target.src=broken} />
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="user-biz-edit-delete-icons">
                            <NavLink className="user-biz-add-img-button" to={`/biz/${biz.id}/images/new`}>
                                <img className="user-biz-svg" src={picture} width='16px' alt="pic_svg" onError={e => e.target.src=broken} />
                            </NavLink>
