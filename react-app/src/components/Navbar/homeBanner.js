...
const HomeBanner = () => {
    ...
    if (!isLoaded) return (
        <div className='loading-container'>
            <img className='gulp-loading' src='https://i.imgur.com/NoEXVTv.gif' alt='loading' onError={e => e.target.src=broken} />
        </div>
    );
    return (
                ...
                <div className='homepage-buttons'>
                    ...
                    <a className='homeBanner-link' href='/biz?type=japanese'>
                        <button className='homepage-button sushi-button'>
                            <img src={search} alt='search' className='mag-glass' onError={e => e.target.src=broken} />
